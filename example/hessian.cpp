...
int main(int argc, char* argv[])
{
    ...
    app.add_option("dmf", determinants_map_file, "determinants map file will be a grayscale PNG image with determinant of Hessian as pixels")
        ->required();
    app.add_option("tmf", traces_map_file, "traces map file will be a grayscale PNG image with trace of Hessian as pixels")
        ->required();
    app.add_option("o,--output", output_file, "Output file that will contain green markers where Hessian corner detector tested positive")
        ->required();
